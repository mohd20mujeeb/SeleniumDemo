...
public  void verifyTextfieldSpaceTriming() {
			      ...
			      Assert.assertEquals(driver.findElement(By.id("input-firstname")).getText(), enteredFirstName.trim());
			      Assert.assertEquals(driver.findElement(By.id("input-lastname")).getText(), enteredLastName.trim());
			      Assert.assertEquals(driver.findElement(By.id("input-email")).getText(), enteredEmail.trim());
			      Assert.assertEquals(driver.findElement(By.id("input-telephone")).getText(), enteredTelephone.trim());
		    }
